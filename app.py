...
def render_tactical_pitch_html(team_name):
    ...
    return (
        ...
        f'border:2px solid rgba(255,255,255,.45);'
        f'box-shadow:0 2px 10px {color}66;transition:all .18s cubic-bezier(.34,1.56,.64,1);" '
        f'onmouseover="this.style.transform=\'scale(1.1)\';this.style.border=\'2px solid rgba(255,255,255,.95)\';this.style.boxShadow=\'0 0 0 3px {color}55,0 4px 16px {color}88\'" '
        f'onmouseout="this.style.transform=\'scale(1)\';this.style.border=\'2px solid rgba(255,255,255,.45)\';this.style.boxShadow=\'0 2px 10px {color}66\'">'
        f'{t["formation"]}'
        f'</span>'
        f'</a>'
        f'</div>'
