...
def render_tactical_pitch_html(team_name):
    ...
    return (
        ...
        f'box-shadow:0 2px 10px {color}66;transition:all .15s;display:inline-flex;align-items:center;gap:.35rem;" '
        f'onmouseover="this.style.transform=\'scale(1.07)\';this.style.boxShadow=\'0 4px 16px {color}99\'" '
        f'onmouseout="this.style.transform=\'scale(1)\';this.style.boxShadow=\'0 2px 10px {color}66\'">'
        f'{t["formation"]}'
        f'<span style="font-size:.6rem;opacity:.85">&#128196;</span>'
        f'</span>'
        f'</a>'
        f'</div>'
